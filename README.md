# ngx-imageshift
[![Build Status](https://travis-ci.org/robisim74/ngx-imageshift.svg?branch=master)](https://travis-ci.org/robisim74/ngx-imageshift)
...
Get the [Changelog](https://github.com/robisim74/ngx-imageshift/blob/master/CHANGELOG.md).
...
2. Rename `ngx-imageshift` and `ngxImageshift` everywhere to `my-library` and `myLibrary`.
...
1. `package.json`
    ...
    * `"main": "./bundles/ngx-imageshift.umd.js"` legacy module format 
    * `"module": "./esm5/ngx-imageshift.js"` flat _ES_ module, for using module bundlers such as _Rollup_ or _webpack_
    * `"es2015": "./esm2015/ngx-imageshift.js"` _ES2015_ flat _ESM_ format
...
4. `rollup.config.js` file used by _Rollup_
    ...
    * `moduleName: 'ng.ngxImageshift'` defines the global namespace used by _JavaScript_ apps
...
## Previous versions
- **Angular v5**
    - [Branch](https://github.com/robisim74/ngx-imageshift/tree/angular_v5)

- **Angular v4**
    - [Branch](https://github.com/robisim74/ngx-imageshift/tree/angular_v4)

- **Angular v2**
    - [Branch](https://github.com/robisim74/ngx-imageshift/tree/angular_v2)
